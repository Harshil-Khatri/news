	...
	<body>
		...
		<div class="row">
			...
			<div class="col-5 col-m-12" style="border-radius:10px;border:1px solid black;margin:50px 0px 100px 0px;padding:20px 10px 5px 20px;background-color:#F5F5F5">
				<form method="post" action="php/chng_pwd.php">
				<div class="row">
					<div class="col-2-5 col-s-12 col-m-12">
						<p style="border:0px solid black;margin-top:0px">Old Password : </p>
					</div>
					<div class="col-9-5 col-s-12col-m-12>
						<p ><input type="password" name="old_password" style="width:100%"></p>
					</div>
				<div class="row">
					<div class="col-2-5 col-s-12 col-m-12">
						<p style="border:0px solid black;margin-top:0px">New Password : </p>
					</div>
					<div class="col-9-5 col-s-12col-m-12>
						<p ><input type="password" name="new_password" style="width:100%"></p>
					</div>
				<div class="row">
					<div class="col-2-5 col-s-12 col-m-12">
						<p style="border:0px solid black;margin-top:0px">Confirm New Password : </p>
					</div>
					<div class="col-9-5 col-s-12col-m-12>
						<p ><input type="password" name="confirm_new_password" style="width:100%"></p>
					</div>
				</div>
			...
			<div class="col-4 col-m-12" style="border-radius:10px;border:1px solid black;margin:50px 0px 100px 0px;padding:5px 0px 5px 5px;background-color:#F5F5F5">
				<h2 style="text-align:center;border:none;line-height:0;">New User ?</h2>
				<br></br>
				<p  style="text-align:center;line-height:0;"><b>Register as</b></p>
				<ul class="links" >
