	...
	<body>
		...
		<div class="row">
			...
			<div class="col-6 col-m-12" style="border-right: 2px solid #E0E0E0;margin:50px 0px 100px 0px;padding:5px 10px 5px 20px;background-color:#F5F5F5">
				<h2 style="text-align:center;border:none;">Application form for PR Agency</h2>
				<form method="post" action="php/signup_pr.php">
					<p style="color:red">* required</p>
					
					<p style="text-align:left;color:#002699;border-bottom:1px groove #004d00;">PR Agency Details</p>
					<p style="border:0px solid black;margin:0px">PR Agency Name : <span style="color:red">*</span></p>
					<input type="text" name="agency_name" style="width:100%" >
					<br></br>
...
<!--							<input type="text" name="username" style="width:100%"  >               -->
			...
			<div class="col-4 col-m-12" style="margin:50px 0px 100px 0px;padding:5px 0px 25px 5px;background-color:#F5F5F5">
				<h2 style="text-align:center;border:none;">Features for PR Agency</h2>
				<br></br>
				<ul class="squares">
					<li style="width:100%">
						Register up to 5 Companies.<br></br>
					</li>
					<li style="width:100%">
						Post News under Company.<br></br>
					</li>
					<li style="width:100%">
