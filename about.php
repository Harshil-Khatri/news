...
<html>
	...
	<body>
		...
		<ul class="heads">
			...
			<li class="heads"><a href="home.html" class="active">About Us</a></li>
		...
		<h2 style="border:none;line-height:0;padding-top:50px;">Welcome to</h2>
		<h1 >City News Alert.com</h1>
		<div style="padding:20px 20px 0px;text-align:center;">
			<p>
				City News Alert is online PR portal dedicated to the Industry. It will provide platform for Companies, PR Agencies, Journalist & Media Companies thriving on news related to Plastics Industry.
			</p>
			<p>
				City News Alert allows the companies & PR Agencies to upload their news to the portal in any language, in two formats like pdf or word document and pictures in jpg/jpeg. City News Alert is generating buzz within the Plastics Industry across the world.
			</p>
		</div>
		<br></br>
