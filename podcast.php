						...
						<div class="navbar">
							<div class="dropdown active">
								...
								<div class="dropdown-content">
									...
									<a href="podcast.html" style="background-color:#D3D3D3;">Podcast</a>
								</div>
						  </div> 
						</div>
					</li>
		...
		<div class="row" >
			<div class="col-2 col-m-12 col-s-2" style="padding:20px 0px 20px 20px;">
				<div style="background-color: #F5F5F5;width:100%;font-size:20px;">
					...
					<div style="border-bottom:0px ridge #999999;padding:15px 0px 15px 35px;background-color:#999999" class="linking">
			...
			<div class="col-0-9 col-m-12 col-s-9">
				<audio width="100" controls>
					<source src="MultiMedia/podcasts/horse.ogg" type="audio/ogg">
					<source src="MultiMedia/podcasts/horse.mp3" type="audio/mpeg">
