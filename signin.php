...
<html>
	...
	<body>
		...
		<div class="row">
			...
			<div class="col-4 col-m-12" style="border-radius:10px;border:1px solid black;margin:50px 0px 100px 0px;padding:20px 10px 5px 20px;background-color:#F5F5F5">
				<form method="post" action="php/signin.php">
					<div class="row">
						<div class="col-3 col-s-3 col-m-3">
							<p style="border:0px solid black;margin:0px">Username : </p>
						</div>
						<div class="col-9 col-s-9 col-m-9">
					...
					<div class="row">
						<div class="col-3 col-s-3 col-m-3">
							<p style="border:0px solid black;margin:0px">Password : </p>
						</div>
						<div class="col-9 col-s-9 col-m-9">
					...
					<a href="" style="align:right;color:blue">forgot password ?</a>
				</form>
			</div>
			...
			<div class="col-4 col-m-12" style="border-radius:10px;border:1px solid black;margin:50px 0px 100px 0px;padding:5px 0px 5px 5px;background-color:#F5F5F5">
				...
				<br></br>
				<p  style="text-align:center;line-height:0;font-size:20px"><b>Register as</b></p>
				<br></br>
				<ul class="links" >
